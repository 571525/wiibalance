...
package com.balance.wiiboard.wiiboardStack;


import com.balance.wiiboard.bluetooth.BluetoothDevice;
import com.balance.wiiboard.wiiboardStack.event.*;
            ...
            while (true) {
                ...
                if (connectionOpen == true) {
                    try {
                        ...
                        System.out.println("com/balance/wiiboard " + receiveCon + " exception: receive(bytes) " + e);
                    }
