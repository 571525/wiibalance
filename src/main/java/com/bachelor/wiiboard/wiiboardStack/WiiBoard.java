...
package com.bachelor.wiiboard.wiiboardStack;


import com.bachelor.wiiboard.bluetooth.BluetoothDevice;
import com.bachelor.wiiboard.wiiboardStack.event.*;
...
public class WiiBoard implements BluetoothDevice {
    ...
    protected class CommandListener extends Thread {
        ...
        //Keeps track of readings to prevent two
        private double prevTR = 0.0, prevBR = 0.0, prevTL = 0.0, prevBL = 0.0;
        private double rawTR = 0.0, rawBR = 0.0, rawTL = 0.0, rawBL = 0.0;
            ...
            while (true) {
                ...
                if (connectionOpen == true) {
                    try {
                        ...
                        System.out.println("com/bachelor/wiiboard " + receiveCon + " exception: receive(bytes) " + e);
                    }
