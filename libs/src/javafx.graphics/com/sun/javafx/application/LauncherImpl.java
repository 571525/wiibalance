...
//                + preloaderClass);
        ...
        // Create a new com.wiibalance.Launcher thread and then wait for that thread to finish
        ...
        launcherThread.setName("JavaFX-com.wiibalance.Launcher");
...
//                System.err.println("JavaFX com.wiibalance.Launcher: system is idle");
                if (startCalled.get()) {
...
//                System.err.println("JavaFX com.wiibalance.Launcher: received exit notification");
                exitCalled.set(true);
                shutdownLatch.countDown();
            }
        };
        ...
        try {
            ...
            if (currentPreloader != null && !error && !exitCalled.get()) {
                try {
                    // Call the application init method (on the com.wiibalance.Launcher thread)
            ...
            if (!error) {
                shutdownLatch.await();
//                System.err.println("JavaFX com.wiibalance.Launcher: time to call stop");
            }
